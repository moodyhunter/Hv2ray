...
import (
	...
	// _ "github.com/v2fly/v2ray-core/v5/transport/internet/hysteria2" // TODO: erroneous
...
func (c *CallbackLogWriter) Close() error {
	return nil
}

func (c *CallbackLogWriter) Write(arg string) error {
	WriteLog(arg)
	return nil
}

func DoStart(configBytes string) error {
	log.RegisterHandler(log.NewLogger(func() log.Writer { return &CallbackLogWriter{} }))
...
func init() {
	WriteLog("V2Ray core loaded, version: " + core.Version())
}
